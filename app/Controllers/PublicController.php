...
class PublicController extends BaseController
{
  public function show($slug)
  {
    ...
    $successHtml = '<div class="form-success" id="form-success">'
      ...
      . '</p>'
      . '</div>'
      . '<a href="https://wa.me/5551151035085" class="btn-whatsapp" target="_blank" rel="noopener"'
    ...
    $handlerScript = '<script>'
      ...
      . 'if(wa){'
      . 'wa.href="https://wa.me/551151035085?text="+encodeURIComponent("Ol\u00e1, eu me chamo "+nome+" e gostaria de saber mais sobre os servi\u00e7os de negocia\u00e7\u00e3o de d\u00edvidas e recupera\u00e7\u00e3o judicial.")'
      . '}'
